export const resources = {
  en: {
    translation: {
      ...
      gistSync: {
        ...
        desc: 'Backup and sync your skills, tags, and settings across devices via your private GitHub Gist.',
        tokenLabel: 'GitHub Token (with gist scope)',
        tokenPlaceholder: 'ghp_xxxxxxxxxxxx or github_pat_xxxxxxxxxxxx',
        tokenHint: 'Requires a Personal Access Token with "gist" permission.',
        createTokenLink: 'Generate Token on GitHub',
        statusConnected: 'Connected Private Gist',
        statusNotConnected: 'Not connected to Gist yet',
        lastSynced: 'Last synced: {{time}}',
        neverSynced: 'Never synced',
        pushButton: 'Backup to Cloud (Push)',
        pullButton: 'Restore from Cloud (Pull)',
        pushing: 'Uploading to Gist...',
        pulling: 'Restoring from Gist...',
        pushSuccess: 'Successfully backed up to your private GitHub Gist!',
        pullSuccess: 'Restored {{skillsCount}} skills and {{tagsCount}} tags from Gist!',
        autoSyncLabel: 'Auto sync changes to Gist in background',
        viewGist: 'View Gist Backup',
        tokenRequired: 'Please enter a GitHub Token with "gist" permission first',
  ...
  zh: {
    translation: {
      ...
      gistSync: {
        title: 'GitHub Gist 多端云同步',
        desc: '使用私有 GitHub Gist 在多台电脑、手机或不同浏览器之间云端备份与漫游同步您的 Skills 及标签。',
        tokenLabel: 'GitHub 访问令牌 (Token - 需包含 gist 权限)',
        tokenPlaceholder: 'ghp_xxxxxxxxxxxx 或 github_pat_xxxxxxxxxxxx',
        tokenHint: '需要一个勾选了 gist 权限的 GitHub Personal Access Token。',
        createTokenLink: '去 GitHub 一键创建 Token',
        statusConnected: '关联的私有 Gist',
        statusNotConnected: '尚未关联 Gist',
        lastSynced: '上次同步时间：{{time}}',
        neverSynced: '尚未同步',
        pushButton: '立即备份到云端 (Push)',
        pullButton: '从云端下载恢复 (Pull)',
        pushing: '正在上传备份到 Gist...',
        pulling: '正在从 Gist 恢复数据...',
        pushSuccess: '已成功将全部技能与标签备份到您的私有 GitHub Gist！',
        pullSuccess: '已从云端成功恢复 {{skillsCount}} 个技能与 {{tagsCount}} 个标签！',
        autoSyncLabel: '操作技能时自动后台同步至 Gist',
        viewGist: '查看 Gist 备份',
        tokenRequired: '请先填写包含 gist 权限的 GitHub Token',
